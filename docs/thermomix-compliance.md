...
| **Cannot #5 — personalized incentives to attract a Customer** | Old site said "**A $50 gift card exclusively when you order through my consultant link**" — a personalized incentive. Already removed. Current bullets under "When you order with me, you receive" include "the official Vorwerk accessory voucher…" and "a free welcome and installation service". | ⚠️ The "$50 gift card / through my link" line is **gone**. **Action for Karen:** confirm with her Branch Manager that "official Vorwerk accessory voucher" and "free welcome and installation service" describe the **standard/national** offer and consultant service — not something Karen is adding to attract customers. Soften or remove if there's any doubt. Never state a specific dollar amount unless official materials use it. |
